...
const home = ({about, products}) => {
      ...
      return (
        <div className={`${img} w-screen h-screen bg-no-repeat bg-cover bg-center transition-all duration-1000`}>
            <div className="bg-[#000000b4] w-full h-full flex justify-center items-center">
                ...
                <div className="h-150 w-full flex justify-center items-center md:flex-row flex-col">
