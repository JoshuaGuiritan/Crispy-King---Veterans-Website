    ...
    return(
        <div ref={about} className="w-screen h-screen bg-[radial-gradient(circle_at_top_left,_#da2113,_#b50000)] flex flex-col-reverse md:flex-row justify-center items-center transition-all duration-1000">
            <div className="flex flex-col justify-center items-center xl:mr-20 lg:mr-17 md:mr-10 md:mt-0 mt-6">
                <FadeInSection><img src="/assets/Images/ckopening.png" className="border border-white xl:w-130 lg:w-120 md:w-105 sm:w-110 w-83 transition-all duration-500"/></FadeInSection>
            ...
            <FadeInSection><div className="w-2 xl:h-120 lg:h-110 md:h-95 border-r-2 border-white xl:mr-15 lg:mr-10 md:mr-8 md:block hidden transition-all duraiton-500"></div></FadeInSection>
            <div className="xl:w-119 lg:w-90 md:w-75 sm:w-100 w-82 transition-all duration-500 flex flex-col items-center md:items-start md:justify-start">
                <div className="relative w-full">
                    <FadeInSection><img src="/assets/Icons/Crown.png" className="absolute transition-all duration-500 xl:-top-4 xl:left-111 xl:w-12 lg:-top-4 lg:left-83 lg:w-10 md:-top-3 md:left-69 md:w-8 sm:-top-3 sm:left-82 sm:w-8 -top-2 left-67 w-6" /></FadeInSection>
                </div>
                <h1 className="text-white xl:text-8xl lg:text-7xl md:text-6xl sm:text-6xl text-5xl font-milk transition-all duration-500 mb-2"><FadeInSection>ABOUT US</FadeInSection></h1>
